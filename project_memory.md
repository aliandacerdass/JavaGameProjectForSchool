...
7. **Kullanıcı Görevi Bloklaması ve Adım Geçiş Kuralları (AI Blocker):** Bir adım tamamlandığında, yapay zeka bir sonraki adıma kendi kendine veya otomatik olarak KESİNLİKLE geçmeyecektir. Geliştirici (Andaç, Emre veya Gizem) yapay zekaya açıkça "bir sonraki adıma geç" veya "bir sonraki adıma başla" demediği sürece yapay zeka yeni bir adıma başlayamaz. Geliştirici o adımı test edip onaylayana ve yeni adım için doğrudan talimat verene kadar yapay zeka bekler. Bu kural projedeki tüm geliştiricilerin yapay zekaları için KESİNLİKLE bağlayıcıdır.
