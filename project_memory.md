...
- **Gelişmiş Animasyon Sistemleri:** Harici karmaşık animasyon kütüphaneleri veya state machine yapıları kullanılmayacaktır. Bunun yerine basit kare sayaçları (`kareSayaci`) ve döngüsel dizin indeksleri kullanılarak spritesheet'ten yönlü (Yukarı, Aşağı, Sol, Sağ) kare kırpması yöntemiyle yerel yürüme ve durma animasyonları yapılabilir.
