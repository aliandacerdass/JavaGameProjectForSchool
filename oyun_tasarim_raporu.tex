...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \draw[thick, draw=black!70] (Oyuncu.north) -- (-5.2, 5.2);
        \draw[thick, draw=black!70] (Silah.north) -- (-1.8, 5.2);
        \draw[thick, draw=black!70] (Mermi.north) -- (1.8, 5.2);
        \draw[thick, draw=black!70] (Dusman.north) -- (5.2, 5.2);
        \draw[aggregates] (OyunPaneli.south) -- (0, 5.2);

        % Oyuncu - Silah İlişkisi
        \draw[associates] (Silah.west) -- (Oyuncu.east);

        % Kalıtım Hiyerarşisi - Silahlar (Ortak Ok Başlı)
        \draw[thick, draw=black!70] (KalkanSilahi.north) -- (-3.6, 1.8);
        \draw[thick, draw=black!70] (DonerBicak.north) -- (0.0, 1.8);
        \draw[thick, draw=black!70] (-3.6, 1.8) -- (0.0, 1.8);
        \draw[thick, draw=black!70] (AtesTopu.north) -- (-1.8, 1.8);
        \draw[inherits] (-1.8, 1.8) -- (Silah.south);

        % Kalıtım Hiyerarşisi - Mermi
        \draw[inherits] (DonerBicakMermi.north) -- (Mermi.south);

        % Kalıtım Hiyerarşisi - Düşmanlar (Ortak Ok Başlı)
        \draw[thick, draw=black!70] (GolemDusman.north) -- (4.2, 1.8);
        \draw[thick, draw=black!70] (HizliDusman.north) -- (6.2, 1.8);
        \draw[thick, draw=black!70] (4.2, 1.8) -- (6.2, 1.8);
        \draw[inherits] (5.2, 1.8) -- (Dusman.south);
