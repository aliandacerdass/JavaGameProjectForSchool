...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        % Silah Alt Sınıfları
        \node[subclass] (KalkanSilahi) at (-5.8, -1.5) {
            \begin{tabular}{l}
        ...
        \node[subclass] (AtesTopu) at (-2.9, -1.5) {
            \begin{tabular}{l}
        ...
        \node[subclass] (DonerBicak) at (0.0, -1.5) {
            \begin{tabular}{l}
            \multicolumn{1}{c}{\textbf{DonerBicak}} \\
            \hline
            - yorungeYaricap: double \\
            - donusHizi: double \\
            \hline
            + saldir(panel) \\
            + seviyeAtla() \\
        ...
        % Mermi Alt Sınıfı
        \node[subclass] (DonerBicakMermi) at (2.9, -1.5) {
            \begin{tabular}{l}
        ...
        \node[subclass] (GolemDusman) at (5.8, -1.5) {
            \begin{tabular}{l}
        ...
        \node[subclass] (HizliDusman) at (8.7, -1.5) {
            \begin{tabular}{l}
        ...
        \draw[thick, draw=black!70] (-8.0, 5.6) -- (7.25, 5.6);
        \draw[thick, draw=black!70] (Oyuncu.north) -- (-8.0, 5.6);
        \draw[thick, draw=black!70] (Silah.north) -- (-2.9, 5.6);
        \draw[thick, draw=black!70] (Mermi.north) -- (2.9, 5.6);
        \draw[thick, draw=black!70] (Dusman.north) -- (7.25, 5.6);
        \draw[aggregates] (OyunPaneli.south) -- (0, 5.6);

        % Oyuncu - Silah İlişkisi
        \draw[associates] (Silah.west) -- (Oyuncu.east);

        % Kalıtım Hiyerarşisi - Silahlar (Ortak Ok Başlı)
        \draw[thick, draw=black!70] (KalkanSilahi.north) -- (-5.8, 1.0);
        \draw[thick, draw=black!70] (DonerBicak.north) -- (0.0, 1.0);
        \draw[thick, draw=black!70] (-5.8, 1.0) -- (0.0, 1.0);
        \draw[thick, draw=black!70] (AtesTopu.north) -- (-2.9, 1.0);
        \draw[inherits] (-2.9, 1.0) -- (Silah.south);

        % Kalıtım Hiyerarşisi - Mermi
        \draw[inherits] (DonerBicakMermi.north) -- (Mermi.south);

        % Kalıtım Hiyerarşisi - Düşmanlar (Ortak Ok Başlı)
        \draw[thick, draw=black!70] (GolemDusman.north) -- (5.8, 1.0);
        \draw[thick, draw=black!70] (HizliDusman.north) -- (8.7, 1.0);
        \draw[thick, draw=black!70] (5.8, 1.0) -- (8.7, 1.0);
        \draw[inherits] (7.25, 1.0) -- (Dusman.south);
